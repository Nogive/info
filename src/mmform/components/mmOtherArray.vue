...
<script>
  ...
  export default {
    ...
    created(){
      let vm=this;
      console.log('arrayMixin:',this);
      console.log('items:',vm.schema.items);
    ...
    methods:{
      sendData(){
        ...
        console.log('utils:',ncformCommon.ncformUtils);
        
        this.schema.value.push({liuyan:"xxx", shuliang:2, jiage:7});
